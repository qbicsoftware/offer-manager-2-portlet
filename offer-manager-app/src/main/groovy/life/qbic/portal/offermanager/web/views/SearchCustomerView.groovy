...
class SearchCustomerView extends FormLayout {
    ...
    private void bindViewModel() {
        Binder<life.qbic.portal.offermanager.web.viewmodel.SearchCustomerViewModel> binder = new Binder<>()
    ...
    private void bindFirstNameField(Binder<life.qbic.portal.offermanager.web.viewmodel.SearchCustomerViewModel> binder) {
    ...
    private void bindLastNameField(Binder<life.qbic.portal.offermanager.web.viewmodel.SearchCustomerViewModel> binder) {
