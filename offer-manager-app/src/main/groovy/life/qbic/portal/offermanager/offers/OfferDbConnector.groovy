...
class OfferDbConnector implements CreateOfferDataSource{
    ...
    List<life.qbic.portal.offermanager.shared.OfferOverview> loadOfferOverview() {
        ...
        connection.withCloseable {
            ...
            while (resultSet.next()) {
                ...
                life.qbic.portal.offermanager.shared.OfferOverview offerOverview = new life.qbic.portal.offermanager.shared.OfferOverview(offerId,
