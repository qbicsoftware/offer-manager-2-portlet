...
class ProjectInformationView extends VerticalLayout {
    ...
    ProjectInformationView(life.qbic.portal.offermanager.web.viewmodel.CreateOfferViewModel createOfferViewModel) {
    ...
    private void bindViewModel() {
        Binder<life.qbic.portal.offermanager.web.viewmodel.CreateOfferViewModel> binder = new Binder<>()
