...
class CreateCustomerView extends VerticalLayout {
    ...
    final life.qbic.portal.offermanager.web.controllers.CreateCustomerController controller
    ...
    CreateCustomerView(life.qbic.portal.offermanager.web.controllers.CreateCustomerController controller, life.qbic.portal.offermanager.web.viewmodel.ViewModel sharedViewModel, CreateCustomerViewModel createCustomerViewModel) {
        super()
