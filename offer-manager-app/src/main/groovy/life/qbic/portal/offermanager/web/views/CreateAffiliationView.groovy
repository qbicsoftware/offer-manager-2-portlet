...
class CreateAffiliationView extends VerticalLayout {
    final public life.qbic.portal.offermanager.web.viewmodel.ViewModel sharedViewModel
    final public life.qbic.portal.offermanager.web.viewmodel.CreateAffiliationViewModel createAffiliationViewModel
    private final life.qbic.portal.offermanager.web.controllers.CreateAffiliationController controller
    ...
    CreateAffiliationView(life.qbic.portal.offermanager.web.viewmodel.ViewModel sharedViewModel, life.qbic.portal.offermanager.web.viewmodel.CreateAffiliationViewModel createAffiliationViewModel, life.qbic.portal.offermanager.web.controllers.CreateAffiliationController controller) {
        super()
    ...
    private void bindViewModel() {
        Binder<life.qbic.portal.offermanager.web.viewmodel.CreateAffiliationViewModel> binder = new Binder<>()
