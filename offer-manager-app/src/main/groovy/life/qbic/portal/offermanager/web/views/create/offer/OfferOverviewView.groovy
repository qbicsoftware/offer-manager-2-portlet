package life.qbic.portal.offermanager.web.views.create.offer
...
class OfferOverviewView extends VerticalLayout{
    ...
    private static void setupFilters(ListDataProvider<Product> productListDataProvider,
        ...
        life.qbic.portal.offermanager.web.views.GridUtils.setupColumnFilter(productListDataProvider,
    ...
    private void addOfferResource(Offer offer) {
        ...
        final def converter = new life.qbic.portal.offermanager.offers.OfferToPDFConverter(offer)
