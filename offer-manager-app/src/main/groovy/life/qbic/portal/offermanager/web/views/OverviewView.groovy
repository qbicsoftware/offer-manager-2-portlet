...
import life.qbic.portal.offermanager.shared.OfferOverview
...
class OverviewView extends FormLayout {
    ...
    OverviewView(OfferOverviewModel model, life.qbic.portal.offermanager.services.OfferUpdateService offerUpdateService) {
        this.model = model
