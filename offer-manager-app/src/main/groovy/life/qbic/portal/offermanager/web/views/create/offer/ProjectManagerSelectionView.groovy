...
class ProjectManagerSelectionView extends VerticalLayout{
    ...
    private final life.qbic.portal.offermanager.web.viewmodel.CreateOfferViewModel viewModel
    ...
    ProjectManagerSelectionView(life.qbic.portal.offermanager.web.viewmodel.CreateOfferViewModel viewModel){
    ...
    private void setupFilters(ListDataProvider<ProjectManager> projectManagerListDataProvider) {
        ...
        life.qbic.portal.offermanager.web.views.GridUtils.setupColumnFilter(projectManagerListDataProvider,
