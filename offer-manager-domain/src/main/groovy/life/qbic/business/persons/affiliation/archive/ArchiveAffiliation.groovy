...
class ArchiveAffiliation implements ArchiveAffiliationInput {
    ...
    private final ArchiveAffiliationDataSource dataSource
     ...
     */
    ArchiveAffiliation (ArchiveAffiliationOutput output, ArchiveAffiliationDataSource dataSource) {
    ...
    void archiveAffiliation(Affiliation affiliation) {
        try {
            dataSource.archive(affiliation)
