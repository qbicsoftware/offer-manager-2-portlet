...
class OfferContentSpec extends Specification {
  ...
  def "An OfferContent with different content are not equal for different #argumentName"() {
    ...
    "afterTax"                                 | customerWithAllAffiliations | internalAffiliation | projectManager1 | creationDate   | expirationDate  | "title"      | "description"    | "experimental design" | "oabcd1"        | items               | items             | items               | 333           | 444                     | 444                   | 444              | 444               | 444             | 444        | 444       | 444     | 0        | 19       | 20                  | 777
    ...
    "discountAmount"                      | customerWithAllAffiliations | internalAffiliation | projectManager1 | creationDate   | expirationDate  | "title"      | "description"    | "experimental design" | "oabcd1"        | items               | items             | items               | 333           | 444                     | 444                   | 444              | 444               | 444             | 444        | 444       | 444     | 444      | 19       | 0                   | 777
